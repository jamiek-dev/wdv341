...
<body>
	...
	<section>
		...
		<?php
		if(is_array($_GET) && array_key_exists('is_logged_in', $_GET)) {
			$signedOn = $_GET['is_logged_in'];	//Had the user signed into the system or needs to see the Login Form
		} else {
			$signedOn = false;
		}
		...
		?>
			<form method="get" action="http://wdv-341-wh1.jkdev/wdv341/unit-3/php-basics-2.php">
